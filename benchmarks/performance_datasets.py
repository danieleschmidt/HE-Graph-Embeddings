...
class GraphBenchmarkSuite:
    ...
    def _save_benchmark_results(self, results: List[BenchmarkResult], analysis: Dict[str, Any]):
    ...
    def _generate_benchmark_report(self, results: List[BenchmarkResult], analysis: Dict[str, Any]):
