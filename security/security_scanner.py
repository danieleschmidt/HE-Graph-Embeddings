...
class SecurityScanner:
    ...
    def _check_vulnerabilities(self, file_path: Path, content: str):
    ...
    def _check_config_security(self, file_path: Path, content: str):
    ...
    def _check_dockerfile_security(self, file_path: Path, content: str):
    ...
    def _check_dependency_security(self, file_path: Path, content: str):
    ...
    def _check_git_secrets(self, file_path: Path):
